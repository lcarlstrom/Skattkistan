...
Användaren av skriptet får ta del av ett grafiskt interface med versionsnummer, input-låda, generations-knapp och hjälp knapp.
Hjälp knappen visar en manual för skriptet. 
